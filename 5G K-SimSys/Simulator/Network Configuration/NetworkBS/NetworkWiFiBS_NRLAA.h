...
#ifndef NETWORKWiFiBS_H
#define NETWORKWiFiBS_H
...
public:
	...
	arma::mat LargeScaleParameter(int ChannelModel, int ChannelCondition, int bsID0, int bsID1);
	int location;
};
