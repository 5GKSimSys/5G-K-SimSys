...
int main()
{
	...
	Sim.Initialize("NReMBB_IndoorOffice"); // NReMBB_UrbanMacroCell, NReMBB_DenseUrban, NReMBB_IndoorOffice, NReMBB_RuralMacroCell
	...
	for (int i = 0; i < Sim.numIteration; i++)
	{
		...
		{
			//Sim.scheduling->BufferUpdate(); // System buffer update for non full buffer MS
