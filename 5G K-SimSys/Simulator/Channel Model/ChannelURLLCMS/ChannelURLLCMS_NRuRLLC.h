...
Channel Model for Mobile Station header (NR uRLLC)


PROJECT NAME : System Level Simulator High Level Design
FILE NAME    : ChannelURLLCMS_NRuRLLC.h
DATE         : 2016.10.5
VERSION      : 0.11
...
#ifndef CHANNELURLLCMS_H
#define CHANNELURLLCMS_H
...
class ChannelURLLCMS//: public SpatialChannel
{
public:
