...
Channel Model for Mobile Station header (FD MIMO)


PROJECT NAME : System Level Simulator High Level Design
FILE NAME    : ChannelMS_FD MIMO.h
DATE         : 2016.10.5
VERSION      : 0.11
...
#ifndef CHANNELWIFIMS_H
#define CHANNELWIFIMS_H
...
class ChannelWiFiMS//: public SpatialChannel
{
public:
