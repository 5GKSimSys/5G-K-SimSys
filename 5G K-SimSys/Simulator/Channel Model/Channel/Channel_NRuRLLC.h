...
Channel model header (NR uRLLC)


PROJECT NAME : System Level Simulator High Level Design
FILE NAME    : Channel_NRuRLLC.h
DATE         : 2016.01.26
VERSION      :
...
public:
	...
	Channel_Parameter NRuRLLC; // FD MIMO channel parameter
	...
	void TemporaryGlobalVariableInitialize(int msID, int type);
