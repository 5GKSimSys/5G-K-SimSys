...
Channel Model for Base Station header (FD MIMO)


PROJECT NAME : System Level Simulator High Level Design
FILE NAME    : ChannelBS_NRLAA.h
DATE         : 2017.02.01
VERSION      : 0.11
...
#ifndef CHANNELWIFIBS_H
#define CHANNELWIFIBS_H
...
public:
	...
	void LongTermChannel(int bsID);
	void ShortTermChannel(int bsID);
